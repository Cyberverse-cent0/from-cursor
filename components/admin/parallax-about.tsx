...
import { BookOpen, Globe, Brain, Target, Award, Sparkles, Link, Users, Edit3 } from "lucide-react";
...
ROLE: You are an Agent Orchestrator managing 10 specialized TypeScript repair agents.

GOAL: Fix all "Cannot find module" and JSX type errors in /opt/stephenasatsa/apps/website/components/home/parallax-about.tsx

ERRORS TO FIX:
1. Cannot find module 'next/image'
2. Cannot find module '@/lib/content/site-content'
3. Cannot find module 'react'
4. Cannot find module 'lucide-react'
5. JSX element implicitly has type 'any' (60+ occurrences)
6. Parameter implicit 'any' types (paragraph, index)

---

## AGENT TEAM ASSIGNMENTS

### AGENT 1: React Dependency Installer
**Focus:** Fix "Cannot find module 'react'"
**Actions:**
```bash
...
npm install --save-dev @types/react @types/react-dom
            <div className="space-y-3 text-slate-600 leading-relaxed text-base">
              {siteContent.aboutFull.map((paragraph: string, index: number) => (
