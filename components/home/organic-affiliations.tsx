        ...
        <div className="relative mb-20">
          ...
          {keyAffiliations.map((affiliation, index) => {
            ...
            return (
              ...
              >
                <Card 
                  className={`${sizeClasses[affiliation.size]} p-6 transition-all duration-700 cursor-pointer border-2 border-transparent hover:border-blue-500 hover:shadow-2xl hover:scale-110 bg-white/80 backdrop-blur-sm overflow-hidden`}
