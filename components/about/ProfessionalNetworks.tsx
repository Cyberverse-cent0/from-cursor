  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-navy/5 rounded-full blur-3xl" />
      ...
      <div className="container-shell relative z-10">
        <div className="space-y-16">
          ...
          >
            ...
            >
              Professional{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-navy to-navy-600">
                Networks & Profiles
              </span>
            </motion.h2>
            <motion.p 
